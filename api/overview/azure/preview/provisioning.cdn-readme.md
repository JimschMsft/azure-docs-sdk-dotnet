---
title: Azure Provisioning Cdn client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.Cdn, provisioning
ms.date: 03/13/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: provisioning
---
# Azure Provisioning Cdn client library for .NET - version 1.0.0-beta.1 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.Cdn_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
