...
---
# Azure Provisioning Network client library for .NET - version 1.0.0 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.Network_1.0.0/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
