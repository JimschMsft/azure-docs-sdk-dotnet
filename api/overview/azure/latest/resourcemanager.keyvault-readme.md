...
- [Quickstart](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.KeyVault_1.4.0/doc/dev/mgmt_quickstart.md).
- [API References](https://learn.microsoft.com/dotnet/api/?view=azure-dotnet).
- [Authentication](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.KeyVault_1.4.0/sdk/identity/Azure.Identity/README.md).
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.KeyVault_1.4.0/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
